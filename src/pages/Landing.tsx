...
import { APK_URL, APP_LOGO, APP_NAME, APP_TAGLINE, DEFAULT_COMMISSION_PERCENT } from '../lib/brand';
...
export default function Landing() {
  ...
  // A referral visit must land on the web registration page first.
  useEffect(() => {
    if (refCode) navigate(`/register?ref=${encodeURIComponent(refCode)}`, { replace: true });
  }, [refCode, navigate]);
      ...
      <div className="lp">
        <div className="header">
          <div className="logo-section">
            <img src={APP_LOGO} alt="HK Wallet Logo" className="logo-img" />
        ...
        <div className="content">
          ...
          <button className="btn-download main-action-btn" onClick={() => startDownload()}>
            Download App
          </button>
          ...
          <div className="recharge-section">
            <div className="info-block-header">Referral Commission</div>
            <div className="levels-grid">
              <div className="level-card level-a">
                <div className="level-name">Every member</div>
                <div className="level-badge">{DEFAULT_COMMISSION_PERCENT}%</div>
                <div className="level-footer">On each referred deposit</div>
              </div>
              <div className="level-card level-c">
                <div className="level-name">Partner agent</div>
                <div className="level-badge">Custom</div>
                <div className="level-footer">Rate set by admin</div>
              </div>
            </div>
            <p className="info-paragraph" style={{ marginTop: 14, textAlign: 'center' }}>
              Commission is credited to your wallet once the referred deposit is approved.
            </p>
          </div>
